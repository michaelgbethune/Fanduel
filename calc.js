...
var pts = fs.readFileSync(".\\js\\pts.txt", 'utf8');
pts = pts.split("\r\n");
        ...
        for (var k = 1; k <= 20; k++){
            if(contents[k]) {
                ...
                if (content[0]) {
                    ...
                    players[name][file.split(".")[0]].position = k;
                    players[name][file.split(".")[0]].week = parseInt(file.split(".")[0].split("week")[1]);
